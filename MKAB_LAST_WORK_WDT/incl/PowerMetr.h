...
public:
  ...
  void Init(Data_Params const * DataPtr, TTaskListConfig const *TaskPtr);
...
{  
public:
  IDetector(DWord* adcmem,DWord* etalon, float koef, Byte ptype, Byte index, float mult);
  ~IDetector();
...
public:
  ...
  TVoltageDetector(DWord* adcmem, DWord* etalon, float koef, Byte ptype, Byte index, float mult, float del);
  ~TVoltageDetector();
