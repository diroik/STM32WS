...
addres_to_jump = BOOT_PARAMS.AppAdrStart + 0x1000;

if(BOOT_PARAMS.BootStatus == 1)
{
...
{ 
    ...
    {   
      case RX_CMD:
        if(TCmd::ResetFlg == true){ ExecutableCMD->SetFase(99);}
