...
//#define NVIC_VectTab_FLASH           ((uint32_t)0x08000000)//in misc.h
...
public:
       ...
       static bool   WriteByteToEeprom_MY(Byte const * PageAddr, Word size_wr, Byte* ram_buf);
       ...
       static void   WriteEepromBufToPage(Byte const * PageAddr, Byte *Buf, Word BufLen);
       static bool   ClrEepromFlashSegment(Byte const *SegAddr);
