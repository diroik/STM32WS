...
__weak void USB_HP_IRQHandler(void);
__weak void USB_LP_IRQHandler(void);
__weak void DAC_IRQHandler(void);
__weak void COMP_IRQHandler(void);
...
void Reset_Handler (void)
{
    //NVIC_SetVectorTable(NVIC_VectTab_FLASH, 0x7400);
...
#pragma weak USB_HP_IRQHandler         = IntDefaultHandler
#pragma weak USB_LP_IRQHandler         = IntDefaultHandler
#pragma weak DAC_IRQHandler            = IntDefaultHandler
#pragma weak COMP_IRQHandler           = IntDefaultHandler
